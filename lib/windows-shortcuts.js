...
function generateCommand(type, path, options) {
	...
	var command = '"shortcut/shortcut.exe"' +
		' /A:' + type +
		' /F:"' + path + '"';
...
exports.query = function(path, callback) {
	exec('"shortcut/shortcut.exe" /A:Q /F:"' + path + '"',
...
exports.create = function(path, opt_cb_tgt, callback) {
	var options = typeof opt_cb_tgt === 'string' ? {target : opt_cb_tgt} :
	              typeof opt_cb_tgt === 'object' ? opt_cb_tgt :
				                                   null;
	callback = typeof opt_cb_tgt === 'function' ? opt_cb_tgt : callback;
